...
Welcome to `BiocFrame` contributor's guide.
...
If you experience bugs or general issues with `BiocFrame`, please have a look
...
You can help improve `BiocFrame` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`BiocFrame` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `BiocFrame`'s files. While this mechanism can
...
```
conda create -n BiocFrame python=3 six virtualenv pytest pytest-cov
conda activate BiocFrame
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/BiocFrame.git
   cd BiocFrame
   ```
...
5. Install [pre-commit]:
   ...
   `BiocFrame` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/BiocFrame
[issue tracker]: https://github.com/<USERNAME>/BiocFrame/issues
