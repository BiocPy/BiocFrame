...
def test_bframe_setters_with_rows():
    ...
    bframe = BiocFrame(obj)
    bframe2 = bframe.set_slice(slice(1, 3), ["column1", "column2"], BiocFrame(
    ...
    bframe = BiocFrame(obj)
    bframe2 = bframe.set_slice(slice(1, 3), [1, 0], BiocFrame(
        {"column1": [20, 30], "column2": ["E", "F"]}
    ))
    ...
    bframe = BiocFrame(obj)
    bframe2 = bframe.set_slice(slice(1, 3), ["column2", "column1"], BiocFrame(
        {"column1": [20, 30], "column2": ["E", "F"]}
    ))
    assert bframe2.column("column1") == [1, "E", "F", 4, 5]
    assert bframe2.column("column2") == ["b", 20, 30, "a", "c"]
